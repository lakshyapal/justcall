...
<head>
    ...
    <link rel="shortcut icon" href="https://justcall.io/theme/assets/img/logo-fav.png">
    <title>Beagle</title>
    ...
    <link rel="stylesheet" type="text/css" href="https://justcall.io/theme/assets/lib/material-design-icons/css/material-design-iconic-font.min.css"/><!--[if lt IE 9]>
    <script src="https://oss.maxcdn.com/html5shiv/3.7.2/html5shiv.min.js"></script>
    <script src="https://oss.maxcdn.com/respond/1.4.2/respond.min.js"></script>
    <![endif]-->
    <link rel="stylesheet" type="text/css" href="https://justcall.io/theme/assets/lib/jquery.vectormap/jquery-jvectormap-1.2.2.css"/>
    <link rel="stylesheet" type="text/css" href="https://justcall.io/theme/assets/lib/jqvmap/jqvmap.min.css"/>
    <link rel="stylesheet" type="text/css" href="https://justcall.io/theme/assets/lib/datetimepicker/css/bootstrap-datetimepicker.min.css"/>
              ...
              <li class="dropdown"><a href="#" data-toggle="dropdown" role="button" aria-expanded="false" class="dropdown-toggle"><span class="icon mdi mdi-notifications"></span><span class="indicator"></span></a>
                <ul class="dropdown-menu be-notifications">
                  <li>
                    ...
                    <div class="list">
                      <div class="be-scroller ps-container ps-theme-default" data-ps-id="ca3e922e-dfd9-576a-2193-ab04e74101cf">
                        <div class="content">
                          <ul>
                            ...
                            <li class="notification"><a href="#">
                                <div class="image"><img src="https://justcall.io/theme/assets/img/avatar3.png" alt="Avatar"></div>
                                <div class="notification-info">
                                  <div class="text"><span class="user-name">Joel King</span> is now following you</div><span class="date">2 days ago</span>
                                </div></a></li>
                            <li class="notification"><a href="#">
                                <div class="image"><img src="https://justcall.io/theme/assets/img/avatar4.png" alt="Avatar"></div>
                                <div class="notification-info">
                                  <div class="text"><span class="user-name">John Doe</span> is watching your main repository</div><span class="date">2 days ago</span>
                                </div></a></li>
                            <li class="notification"><a href="#">
                                <div class="image"><img src="https://justcall.io/theme/assets/img/avatar5.png" alt="Avatar"></div>
